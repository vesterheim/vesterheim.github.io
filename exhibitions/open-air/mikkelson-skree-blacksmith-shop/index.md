...
published: true
layout: page
title: Mikkelson-Skree Blacksmith Shop
subtitle: Sheldon Township, Houston County, Minnesota (1854)
meta_title:        # Appears on bookmarks, search results, etc...
meta_description:  # Used in HTML head and as the description for some search engines
# Ratio: 16:9 | Recommended: 1492px by 840px | Minimum: 746px by 420px
hero:
  image: 16x9/buildings/mikkelson-skree-blacksmith-shop--interior.jpg
  alt:
  caption:
related:
...
pagelist:
  order: 50
  image: 46x21/buildings/mikkelson-skree-blacksmith-shop.jpg
  alt:
  caption: 
