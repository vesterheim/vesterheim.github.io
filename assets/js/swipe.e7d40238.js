...
(function(w) {
    ...
    w.setupCarousel = function() {
        ...
        var slides = carousel.getElementsByClassName("carousel__item"), slidesLength = slides.length;
        if (slidesLength <= 1) {
            return;
        }
        ...
        window.mySwipe = Swipe(carousel, {
            ...
            callback: function(index, elem) {
                ...
                while (i--) {
                    indicators[i].className = indicators[i].className.replace(/\s*\bis_active\b/gi, "");
                }
    ...
    w.positionCarouselControlls = function() {
        ...
        var bullets = carousel.getElementsByClassName("js__layout__carousel__position"), controls = carousel.getElementsByClassName("js__layout__carousel__control"), imageWrappers = carousel.getElementsByClassName("layout__carousel__image__wrapper");
        if (matchMedia("screen and (min-width: 40em)").matches) {
            w.setStyle(controls, "height", "auto");
            w.setStyle(imageWrappers, "minHeight", "auto");
            return;
        }
        var imageWidth = carousel.offsetWidth, imageHeight = imageWidth * 9 / 25;
