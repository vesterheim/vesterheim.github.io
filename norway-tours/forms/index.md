...
{% include components/button.html text="Download Registration Form (PDF)" url="/norway-tours/forms/documents/DepositForm.pdf" style="primary" %} 

Be sure to read the "[Terms and Conditions](/norway-tours/forms/documents/TermCond.pdf)" for each tour.

{% include components/button.html text="Download Terms and Conditions (PDF)" url="/norway-tours/forms/documents/DepositForm.pdf" style="primary" %} 